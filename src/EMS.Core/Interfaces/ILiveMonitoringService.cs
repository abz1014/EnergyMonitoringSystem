...
{
    public StatusSummaryDto StatusSummary { get; set; }
    public List<MeterLiveDto> Meters { get; set; }
...
public class MeterLiveDto
{
    ...
    public VoltageReadingDto Voltage { get; set; }
    public CurrentReadingDto Current { get; set; }
    public PowerReadingDto Power { get; set; }
